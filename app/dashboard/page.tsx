...
import { Sparkles, Flame, Coins, Heart, MessageSquare, Compass, ArrowRight, RefreshCw } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="glass-card-gold p-6 rounded-3xl border-yellow-400/40 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl">
      ...
      <section className="flex flex-col items-center space-y-4">
        <div className="text-center space-y-1">
          <span className="text-xs uppercase tracking-widest text-purple-300 font-semibold flex items-center justify-center gap-1">
            <Sparkles className="w-3.5 h-3.5 text-yellow-400" /> Tirage d'Arcane Majeure
          </span>
          <h1 className="text-3xl font-bold font-serif text-white">Votre Carte du Jour 🔮</h1>
        </div>
